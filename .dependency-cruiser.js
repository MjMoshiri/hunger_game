...
module.exports = {
  forbidden: [
    ...
    {
      name: 'only-repo-to-db',
      comment:
        'Only the repository layer (src/repo) may import the database (src/db). ' +
        'All other modules must go through a repository so data access stays in one ' +
        'place and the rest of the app never talks to the db client directly.',
      severity: 'error',
      from: {
        pathNot: '^src/(?:repo|db)/'
      },
...
// generated: dependency-cruiser@17.4.3 on 2026-06-20T02:33:56.576Z
